package es.ulpgc.software.imageviewer.architecture.presenter;

import es.ulpgc.software.imageviewer.architecture.model.Image;
import es.ulpgc.software.imageviewer.architecture.model.ImageDisplay;

import static es.ulpgc.software.imageviewer.architecture.model.ImageDisplay.*;
...
public class ImagePresenter {
    ...
    public ImagePresenter(ImageDisplay display) {
        ...
        this.display.on((Released) offset -> {
